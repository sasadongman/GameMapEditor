package com.riaspace.nativeUpdater
{
	...
	public class NativeUpdater extends EventDispatcher
	{
		public static const UPDATE:String = "NativeUpdate";
		 ...
		 */
		public static var UPDATE_DESCRIPTOR_URL:String = "";
		...
		protected function openUpdateFolder():void
		{
			var saveFile:File = File.applicationStorageDirectory.resolvePath(updateFile.name);
			updateFile.copyTo(saveFile, true);
			File.applicationStorageDirectory.openWithDefaultApplication();
			dispatchEvent(new Event(NativeUpdater.UPDATE));
		}
